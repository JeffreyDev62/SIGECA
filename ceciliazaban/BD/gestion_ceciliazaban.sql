...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2025 a las 23:50:37
...
INSERT INTO `anios_escolares` (`id`, `nombre`, `fecha_inicio`, `fecha_fin`, `activo`, `fecha_creacion`) VALUES
(104, '2024-2025', '2024-01-01', '2025-12-31', 0, '2025-11-05 06:43:33'),
(105, '2025-2026', '2025-01-05', '2026-12-05', 1, '2025-11-05 06:49:33');
...
--
-- Volcado de datos para la tabla `asignaciones_aula`
--

INSERT INTO `asignaciones_aula` (`id`, `anio_escolar_id`, `nombre_aula`, `turno`, `docente_id`, `activo`, `fecha_creacion`) VALUES
(1, 104, 'Primero A', 'Mañana', 2, 1, '2025-11-05 06:47:23'),
(2, 105, 'Segundo B', 'Mañana', 2, 1, '2025-11-05 06:49:58');
...
INSERT INTO `estudiantes` (`id`, `cedula`, `nombre`, `apellido`, `edad`, `genero`, `fecha_nacimiento`, `lugar_nacimiento`, `representante_id`, `activo`, `fecha_creacion`) VALUES
(1, '12345678', 'Jose', 'Perez', 10, '', '2015-03-05', 'San felipe', 1, 1, '2025-11-05 06:45:20'),
(2, '56789106', 'Maria', 'Osorio', 8, '', '2017-01-05', 'San felipe', 2, 1, '2025-11-05 06:51:34');
...
INSERT INTO `inscripciones` (`id`, `estudiante_id`, `aula_id`, `anio_escolar_id`, `fecha_inscripcion`, `activo`) VALUES
(1, 1, 1, 104, '2025-11-05 06:47:50', 1),
(2, 2, 2, 105, '2025-11-05 06:52:46', 1);
...
INSERT INTO `representantes` (`id`, `cedula`, `nombre`, `apellido`, `telefono`, `ocupacion`, `activo`, `fecha_creacion`) VALUES
(1, '0987654', 'Valentina', 'Ramirez', '0412', 'hogareña', 1, '2025-11-05 06:45:20'),
(2, '8765454', 'Jose', 'Peralta', '041255', 'hogareño', 1, '2025-11-05 06:51:34');
